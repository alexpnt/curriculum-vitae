...
\colorhref{mailto:alexandpinto@gmail.com}{\small \faEnvelope{} | alexandpinto@gmail.com}\\ 
...
Software engineer competent in implementing backend systems mainly focused on machine learning services.\\
Generalist who is not bound to any specific language. Proficient in Python, Java and C.\\
Experienced in building distributed systems and comfortable working with Linux or other Unix systems.\\
Enjoy tackling engineering problems with good system design choices, clarity, scalability and performance.
...
\item{\textbf{Web Protocols:} REST/RPC, gRPC with protocol buffers. JSON.}
...
\item{\textbf{Messaging Systems:} Celery with RabbitMQ.}
\item{\textbf{Testing:} Knowledge in  developing unit and integration tests.}
