...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{itemize*}
\item{\textbf{Programming Languages:} Proficient in Python, C and Java.}
\item{\textbf{Web Frameworks:} Django, Django Rest Framework, FastAPI, Falcon, Flask.}
...
\item{\textbf{Deployment and Infrastructure:} Ansible, Docker.}
...
\item{\textbf{Development Tools:} PyCharm, WebStorm, IntelliJ, Datagrip, Sublime Text Editor.}
